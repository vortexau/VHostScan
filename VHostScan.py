...
def main():
    ...
    if(arguments.prepend_transform):
        wordlist = [arguments.prepend_transform + "-" + line for line in wordlist]

    if(arguments.append_transform):
        wordlist = [line + "-" + arguments.append_transform for line in wordlist]
